...
def levelCamera(pitch):
    redboard.servo6_P(cameraAngle - pitch*15)
...
while not done:
    ...
    if joystick.get_button(2) == 1 and cameraAngle > 700.0:
        cameraAngle -= 5.0
        print("Look up...")
    elif joystick.get_button(0) == 1 and cameraAngle < 2000.0:
        cameraAngle += 5.0
        print("Look down...")
    ...
    # Update the motors
    motorLeft.setTorque(leftThrottle)
    motorRight.setTorque(-rightThrottle)
